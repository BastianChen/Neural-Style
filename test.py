...
# 输出图像的所需尺寸
imsize = 512 if torch.cuda.is_available() else 512  # 如果没有GPU，请使用小尺寸
...
style_img = image_loader("images/input/cat.jpg")
content_img = image_loader("images/input/picasso.jpg")
